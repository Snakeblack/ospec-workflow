...
test("real repo: orchestrator pointer-table refs resolve and handler sentinels absent from body", () => {
  ...
  assert.doesNotMatch(text, /archive-transaction-run\.js/, "archive move-completion sentinel 'archive-transaction-run.js' must not be inline in orchestrator body");
  ...
  const sentinelFiles = [
    ...
    { sentinel: "archive-transaction-run.js", file: "skills/_shared/gate-archive-quality.md" },
