...
function evaluateChallengeEvidence(input, bindings, { required = false, evidenceStrategy } = {}) {
  ...
  const gate = validateChallengeResultSet(plan, results, {
    candidate: bindings.candidate,
    executionGraph: bindings.executionGraph,
