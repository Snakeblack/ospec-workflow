...
The suite MUST retain exactly the 9 golden scenarios below: 6 orchestrator-core plus
...
(Previously: exactly 7 goldens, 4 orchestrator-core plus 3 `sdd-document`; the first
core golden was vagueness-triggered restatement and specific requests were out of
corpus.)
