...
const generalist = {
  ...
  reason:
    "signals=dependency-change,design-risk,diff-auth-permission,diff-error-flow,diff-structural-complexity,metadata-runtime,verify-reliability;dimensions=risk,reliability,resilience,readability",
};
...
fs.writeFileSync(path.join(outDir, "gate-plan.json"), JSON.stringify(gatePlan, null, 2));
