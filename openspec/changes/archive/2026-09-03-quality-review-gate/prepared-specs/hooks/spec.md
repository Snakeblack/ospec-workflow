...
(Previously: allowlisted 4R specialists `review-risk`, `review-readability`, `review-reliability`, `review-resilience`.)
...
- WHEN `SubagentStop` classifies the dispatch under the new allowlist
