...
- `openspec/changes/recommendation-contract-and-early-ambiguity-detection/specs/agents/spec.md` — Requirement: `blocker_type` Enum Field Formalization (carries the `blocker_type` documentation obligation raised during clarify into `sdd-design`/`sdd-apply`)
