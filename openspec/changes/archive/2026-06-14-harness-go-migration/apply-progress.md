...
| File | Action | Notes |
|------|--------|-------|
| `go.mod` | Created | Module `github.com/snakeblack/ospec-workflow`, go 1.23 |
...
```
go test ./...
ok  github.com/snakeblack/ospec-workflow/cmd/ospec-hooks    0.296s
ok  github.com/snakeblack/ospec-workflow/internal/hooks     0.517s
...
```
go test -short ./...
ok  github.com/snakeblack/ospec-workflow/cmd/ospec-hooks    0.325s
ok  github.com/snakeblack/ospec-workflow/internal/hooks     0.580s
ok  github.com/snakeblack/ospec-workflow/internal/jsonio    0.265s
ok  github.com/snakeblack/ospec-workflow/internal/rules     0.305s
ok  github.com/snakeblack/ospec-workflow/internal/skillreg  0.324s
ok  github.com/snakeblack/ospec-workflow/internal/store     0.346s
ok  github.com/snakeblack/ospec-workflow/internal/yamllite  0.268s

go test ./...
ok  github.com/snakeblack/ospec-workflow/cmd/ospec-hooks    4.323s
ok  github.com/snakeblack/ospec-workflow/internal/hooks     0.619s
ok  github.com/snakeblack/ospec-workflow/internal/jsonio    0.283s
ok  github.com/snakeblack/ospec-workflow/internal/rules     0.334s
ok  github.com/snakeblack/ospec-workflow/internal/skillreg  0.365s
ok  github.com/snakeblack/ospec-workflow/internal/store     0.358s
ok  github.com/snakeblack/ospec-workflow/internal/yamllite  0.280s
