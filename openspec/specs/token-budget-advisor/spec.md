...
- WHEN el hook `PreToolUse` evalúa la llamada
- THEN el Advisor MUST retornar una decisión de `ask` con una descripción detallada que advierta del costo de 25,000 tokens
...
- GIVEN una sesión activa con 95,000 tokens leídos acumulados
- WHEN se realiza una llamada a herramientas en `PreToolUse`
