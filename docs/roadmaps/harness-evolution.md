...
| `done` | **K6a** | Worker isolation y work-order capsule; primitivas de ejecución aislada, integración con WorkerTransport, contención de filesystem y WorkResult canónico; archivado y publicado en v2.46.0, remediado en v2.46.1 |
...
### K6a — worker isolation y work-order capsule — **done** (v2.46.0, remediado v2.46.1)
