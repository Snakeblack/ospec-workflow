...
| P10 | Review por niveles/selectivo | O4+O5/O4.1 ya entrega generalista + especialistas selectivos/full 4R. | Falta Nivel 0 determinista y tratar performance/compatibility-migration como señales/lenses explícitas. | **Conservar y adaptar** a Nivel 0 sin modelo, Nivel 1 generalista y Nivel 2 selectivo; añadir las dos lenses condicionadas con gate/evals. | K7 |
...
| P13 | Revert/mutation/independent acceptance | Evals/mutation aparecen en O20A; verify es separado. | No son gates normales ni existe challenge manifest. | **Añadir** gradualmente, primero Repair shadow. | K6c/K9 |
...
| P17 | Delivery receipts | O6A emite receipt de archive y usa fingerprints. | No existe receipt de aprobación productivo para commit/push/PR sobre candidato exacto. | **Generalizar** primero como receipt de evaluación y, tras K9, añadir enforcement fail-closed pre-commit/pre-push/pre-PR. | K8/K10-delivery |
