...
> **Estado verificado:** O3, O4+O5/O4.1, O4.2, O6A, O2B, **K1**, **K2**, **K2.1**, **K2a** y **K3** están entregados. `k3-readiness-remediation` debe verificar y archivarse antes de que **K4a** sea elegible.
...
| --- | --- |
| Estado | K1+K2+K2.1+K2a+K3 `done`; **K4a** bloqueada hasta cerrar `k3-readiness-remediation` |
...
9. K6a: primitivas de ejecución aislada (`CreateWorkspace`…`DisposeWorkspace`); no conoce Repair.
10. K4b: orquesta Repair shadow (consume K6a; freeze Candidate vía K3).
