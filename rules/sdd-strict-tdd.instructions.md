...
Load these rules only when Strict TDD Mode is active and a test runner is available. The orchestrator should forward: `STRICT TDD MODE IS ACTIVE. Test runner: {command}.`
